...
vonMisesLinearHardening::vonMisesLinearHardening(entt::registry<>* registry)
...
void 
vonMisesLinearHardening::Initialize() {
...
void 
vonMisesLinearHardening::Update() {

}

math::Tensor4f const&
vonMisesLinearHardening::GetStiffnessTensor() const {
